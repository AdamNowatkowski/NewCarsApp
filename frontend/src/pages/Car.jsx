      ...
      {car &&
        <div>
          <div className='flex flex-col justify-between min-h-full items-center'>
            <div className="font-bold text-x1 text-gray-600 my-3">{car.brand} {car.make}</div>
            <div className='max-w-x1'>
              <img alt="A Car!" serc="https://via.placeholder.com/960x550.png?text=IMAGINE+A+CAR!" />
            </div>
            <div className='flex flex-col items-center font-normal text-lg'>
              <div>Price: <span className='font-semibold text-orange-600 text-x1'>{car.price}</span></div>
            ...
            <div className='flex flex-row'>
              <FormInput label='change price'
                ...
                onChange={onChange}
                required />
              <button onClick={updatePrice} className='bg-yellow-500 text-white p-2 rounded-md m-3 transition-opacity hover:opacity-80'>Edit price</button>
              <button onClick={handleDelete} className='bg-red-500 text-white p-2 rounded-md m-3 transition-opacity hover:opacity-80'>Delete Car</button>
            </div>
            <div>
              <p>Warining: deleting is permanent!</p>
            </div>
